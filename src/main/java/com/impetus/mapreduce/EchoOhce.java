/**
 *
 * EchoOhce accepts one or more strings as input and outputs an
 * (string, reverseofstring) pair for each one, where "string" is a the
 * input string and reverseofstring is its reverse string
 *
